...
fade_duration = 1  # Duration of the fade effects in seconds
zoomed_clip = zoomed_clip.fadein(fade_duration).fadeout(fade_duration)

# Write the result to a file
zoomed_clip.write_videofile("fadeoutput1.mp4")